  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Customer Return Invoice  &ensp;  </h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Customer Return Invoice  &ensp;  </li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
                  ...
                  <tbody>
                    @php 
                      $allData = App\CustomerReturn::orderBy('id', 'desc')->orderBy('return_date', 'desc')->where('return_status','Pending')->get();
                    @endphp
                  ...
                  <tr>
                    ...
                    <td>{{ $data->qty }}</td>
                    <td>{{ $data->price }}</td>
                    <td><a title="Ok" href="{{ route('customer.return.approve', $data->id)}}"  class="btn btn-success btn-sm"><i class="fa fa-check-circle"></i></a></td>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Customer Return Invoice  </h3> 
              ...
              <div class="card-body">
                <form action="{{ route('customer.return.store')}}" method="post" id="myForm">
                  @csrf
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-7">
                      ...
                      <select name="customer_id" id="customer_id" class="form-control-sm form-control"> <!-- select2 class for search -->
                        ...
                        @endforeach
                        <option value="0">New Csutomer</option>
                      </select>
