          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Pending Purchase List 
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped table-responsive">
                  ...
                  <tr>
                    ...
                    <td>
                      @if($purchase->status == 0)
                      <a title="Approve" href="{{ route('purchase.approve', $purchase->id)}}" id="approveBtn" class="btn btn-success btn-sm"><i class="fa fa-check-circle"></i></a>
                      @endif
